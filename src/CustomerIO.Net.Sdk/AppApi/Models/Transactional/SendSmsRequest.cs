...
{
    /// <summary>
    /// The numerical ID or Trigger Name of the transactional SMS template to use.
    /// </summary>
    ...
    /// <summary>
    /// The destination phone number in E.164 format. Overrides the phone number on the profile.
    /// </summary>
    [JsonPropertyName("to")]
    public string? To { get; set; }

    /// <summary>
    /// The SMS body. Overrides the template body.
    /// </summary>
